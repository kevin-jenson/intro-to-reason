...
function remove(tree, compare, v) {
  if (tree) {
    var match = tree[0];
    var left = match[/* left */1];
    var value = match[/* value */0];
    if (left) {
      ...
      if (right) {
        ...
        var match$1 = Curry._2(compare, v, value) === 0;
        if (match$1) {
          return left;
        } else {
          return /* Node */[/* record */[
                    /* value */value,
                    /* left */remove(left, compare, v),
                    /* right */right
                  ]];
        }
      }
    } else {
      var right$1 = match[/* right */2];
      if (right$1) {
        var match$2 = Curry._2(compare, v, value) === 0;
        if (match$2) {
          return right$1;
        } else {
          return /* Node */[/* record */[
                    /* value */value,
                    /* left */left,
                    /* right */remove(right$1, compare, v)
                  ]];
        }
      } else {
        var match$3 = Curry._2(compare, v, value) === 0;
        if (match$3) {
          return /* Empty */0;
        } else {
          return tree;
